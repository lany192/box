 ...
 */
class ScrollLayout : FrameLayout {
    ...
    private fun initView(context: Context, attrs: AttributeSet?, defStyleAttr: Int) {
        ...
        val speed = array.getInteger(R.styleable.ScrollLayout_speed, 3)
        mScrollOrientation =
            array.getInteger(R.styleable.ScrollLayout_scrollOrientation, OUT_SLIDE_TOP)
        mIntervalIncreaseDistance *= speed
        mDrawable = array.getDrawable(R.styleable.ScrollLayout_src)
        mIsScroll = array.getBoolean(R.styleable.ScrollLayout_isScroll, true)
        mMaskLayerColor =
            array.getColor(R.styleable.ScrollLayout_maskLayerColor, Color.TRANSPARENT)
        array.recycle()
