...
public class CommonTabLayout extends FrameLayout implements ValueAnimator.AnimatorUpdateListener {
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        mTextsize = ta.getDimension(R.styleable.CommonTabLayout_tl_text_size, sp2px(13f));
        mTextSelectColor = ta.getColor(R.styleable.CommonTabLayout_tl_text_select_color, Color.parseColor("#ffffff"));
        mTextUnselectColor = ta.getColor(R.styleable.CommonTabLayout_tl_text_unselect_color, Color.parseColor("#AAffffff"));
        mTextBold = ta.getInt(R.styleable.CommonTabLayout_tl_text_bold, TEXT_BOLD_NONE);
        mTextAllCaps = ta.getBoolean(R.styleable.CommonTabLayout_tl_text_all_caps, false);

        mIconVisible = ta.getBoolean(R.styleable.CommonTabLayout_tl_icon_visible, true);
        mIconGravity = ta.getInt(R.styleable.CommonTabLayout_tl_icon_gravity, Gravity.TOP);
        mIconWidth = ta.getDimension(R.styleable.CommonTabLayout_tl_icon_width, dp2px(0));
        mIconHeight = ta.getDimension(R.styleable.CommonTabLayout_tl_icon_height, dp2px(0));
        mIconMargin = ta.getDimension(R.styleable.CommonTabLayout_tl_icon_margin, dp2px(2.5f));
