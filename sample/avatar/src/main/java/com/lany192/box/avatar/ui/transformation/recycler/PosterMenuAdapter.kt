package com.lany192.box.avatar.ui.transformation.recycler
...
import com.lany192.box.avatar.databinding.ItemPosterMenuBinding
import com.lany192.box.avatar.ui.transformation.TransformationDetailActivity
...
class PosterMenuAdapter : RecyclerView.Adapter<PosterMenuAdapter.PosterViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): PosterViewHolder {
        val binding =
            ItemPosterMenuBinding.inflate(LayoutInflater.from(parent.context), parent, false)
            ...
            root.setOnClickListener {
                ...
                if (now - previousTime >= itemPosterMenuTransformationLayout.duration) {
                    TransformationDetailActivity.startActivity(
                        root.context,
                        itemPosterMenuTransformationLayout,
                        item
                    )
                    previousTime = now
                }
