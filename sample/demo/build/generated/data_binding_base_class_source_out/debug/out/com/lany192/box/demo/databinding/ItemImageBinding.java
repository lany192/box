...
public final class ItemImageBinding implements ViewBinding {
  ...
  private ItemImageBinding(@NonNull FrameLayout rootView, @NonNull RatioImageView image) {
  ...
  public static ItemImageBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.image;
      RatioImageView image = ViewBindings.findChildViewById(rootView, id);
      if (image == null) {
        break missingId;
      }

      return new ItemImageBinding((FrameLayout) rootView, image);
    }
