...
public class RefreshView extends RelativeLayout implements RefreshHeader {
    ...
    private void initView(Context context, AttributeSet attrs) {
        ...
        if (ta.hasValue(R.styleable.ClassicsHeader_srlTextSizeTitle)) {
            mTitleText.setTextSize(ta.getDimensionPixelSize(R.styleable.ClassicsHeader_srlTextSizeTitle, 13));
        } else {
            mTitleText.setTextSize(13);
        }

        if (ta.hasValue(R.styleable.ClassicsHeader_srlTextSizeTime)) {
            mLastUpdateText.setTextSize(ta.getDimensionPixelSize(R.styleable.ClassicsHeader_srlTextSizeTime, 10));
        } else {
        ...
        mShared = context.getSharedPreferences("RefreshView", Context.MODE_PRIVATE);
...
//    }
    ...
    public RefreshView setProgressBitmap(Bitmap bitmap) {
        mProgressDrawable = null;
        mProgressView.setImageBitmap(bitmap);
        return this;
    }

    public RefreshView setProgressDrawable(Drawable drawable) {
        mProgressDrawable = null;
        mProgressView.setImageDrawable(drawable);
        return this;
    }

    public RefreshView setProgressResource(@DrawableRes int resId) {
        mProgressDrawable = null;
        mProgressView.setImageResource(resId);
        return this;
    }

    public RefreshView setArrowBitmap(Bitmap bitmap) {
        mArrowDrawable = null;
        mArrowView.setImageBitmap(bitmap);
        return this;
    }

    public RefreshView setArrowDrawable(Drawable drawable) {
        mArrowDrawable = null;
        mArrowView.setImageDrawable(drawable);
        return this;
    }

    public RefreshView setArrowResource(@DrawableRes int resId) {
        mArrowDrawable = null;
        mArrowView.setImageResource(resId);
        return this;
    }

    public RefreshView setLastUpdateTime(Date time) {
        mLastTime = time;
    ...
    public RefreshView setTimeFormat(DateFormat format) {
        mFormat = format;
        mLastUpdateText.setText(mFormat.format(mLastTime));
        return this;
    }

    public RefreshView setSpinnerStyle(SpinnerStyle style) {
    ...
    public RefreshView setAccentColor(int accentColor) {
    ...
    public RefreshView setFinishDuration(int delay) {
        mFinishDuration = delay;
        return this;
    }

    public RefreshView setEnableLastTime(boolean enable) {
    ...
    public RefreshView setTextSizeTitle(float size) {
    ...
    public RefreshView setTextSizeTitle(int unit, float size) {
    ...
    public RefreshView setTextSizeTime(float size) {
    ...
    public RefreshView setTextSizeTime(int unit, float size) {
    ...
    public RefreshView setTextTimeMarginTop(float dp) {
        return setTextTimeMarginTopPx(DensityUtil.dp2px(dp));
    }

    public RefreshView setTextTimeMarginTopPx(int px) {
    ...
    public RefreshView setDrawableMarginRight(float dp) {
        return setDrawableMarginRightPx(DensityUtil.dp2px(dp));
    }

    public RefreshView setDrawableMarginRightPx(int px) {
    ...
    public RefreshView setDrawableSize(float dp) {
        return setDrawableSizePx(DensityUtil.dp2px(dp));
    }

    public RefreshView setDrawableSizePx(int px) {
    ...
    public RefreshView setDrawableArrowSize(float dp) {
        return setDrawableArrowSizePx(DensityUtil.dp2px(dp));
    }

    public RefreshView setDrawableArrowSizePx(int px) {
        ViewGroup.LayoutParams lpArrow = mArrowView.getLayoutParams();
        lpArrow.width = px;
        lpArrow.height = px;
        mArrowView.setLayoutParams(lpArrow);
    ...
    public RefreshView setDrawableProgressSize(float dp) {
        return setDrawableProgressSizePx(DensityUtil.dp2px(dp));
    }

    public RefreshView setDrawableProgressSizePx(int px) {
        ViewGroup.LayoutParams lpProgress = mProgressView.getLayoutParams();
        lpProgress.width = px;
