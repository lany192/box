...
public class RoundedCornersTransform extends BitmapTransformation {
    ...
    public boolean equals(Object o) {
        return o instanceof RoundedCornersTransform &&
                ((RoundedCornersTransform) o).radius == radius &&
                ((RoundedCornersTransform) o).diameter == diameter &&
                ((RoundedCornersTransform) o).margin == margin &&
                ((RoundedCornersTransform) o).cornerType == cornerType;
    }
