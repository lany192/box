...
/**
 * 导航栏，改编至https://github.com/ittianyu/BottomNavigationViewEx
 */
public class NavigationBar extends BottomNavigationView {
    ...
    private BottomViewOnPageChangeListener mPageChangeListener;
     ...
     * @param visibility
     */
    public NavigationBar setIconVisibility(boolean visibility) {
        /*
...
//                            System.out.println("mIcon.getMeasuredHeight():" + mIcon.getMeasuredHeight());
     ...
     * @param visibility
     */
    public NavigationBar setTextVisibility(boolean visibility) {
...
//            System.out.println("mLargeLabel.getMeasuredHeight():" + getFontHeight(mSmallLabelSize));
     ...
     */
    public NavigationBar enableAnimation(boolean enable) {
        /*
        1. get field in this class
        private final BottomNavigationMenuView mMenuView;
...
//     */
//    @Deprecated
//    public BottomView enableShiftingMode(boolean enable) {
//        /*
//        1. get field in this class
//        private final BottomNavigationMenuView mMenuView;
//
...
//     */
//    @Deprecated
//    public BottomView enableItemShiftingMode(boolean enable) {
//        /*
//        1. get field in this class
//        private final BottomNavigationMenuView mMenuView;
//
...
//    }
     ...
     */
    public NavigationBar setCurrentItem(int index) {
     ...
     * @param sp
     */
    public NavigationBar setSmallTextSize(float sp) {
     ...
     * @param sp
     */
    public NavigationBar setLargeTextSize(float sp) {
        int count = getItemCount();
        for (int i = 0; i < count; i++) {
     ...
     * @param sp
     */
    public NavigationBar setTextSize(float sp) {
        setLargeTextSize(sp);
        setSmallTextSize(sp);
        return this;
    }
     ...
     * @param height   in dp
     */
    public NavigationBar setIconSizeAt(int position, float width, float height) {
     ...
     * @param height in dp
     */
    public NavigationBar setIconSize(float width, float height) {
        int count = getItemCount();
        for (int i = 0; i < count; i++) {
     ...
     * @param dpSize in dp
     */
    public NavigationBar setIconSize(float dpSize) {
     ...
     * @param height in px
     */
    public NavigationBar setItemHeight(int height) {
        // 1. get mMenuView
        final BottomNavigationMenuView mMenuView = getBottomNavigationMenuView();
     ...
     */
    public NavigationBar setTypeface(Typeface typeface, int style) {
        int count = getItemCount();
        for (int i = 0; i < count; i++) {
     ...
     * @attr ref android.R.styleable#TextView_typeface
     */
    public NavigationBar setTypeface(Typeface typeface) {
        int count = getItemCount();
        for (int i = 0; i < count; i++) {
    ...
    /**
     * This method will link the given ViewPager and this BottomView together so that
     ...
     */
    public NavigationBar setupWithViewPager(final ViewPager viewPager, boolean smoothScroll) {
        if (mViewPager != null) {
        ...
        if (mPageChangeListener == null) {
            mPageChangeListener = new BottomViewOnPageChangeListener(this);
        }
     ...
     * necessary calls back to the provided {@link NavigationBar} so that the tab position is
     * kept in sync.
     * <p>
     * <p>This class stores the provided BottomView weakly, meaning that you can use
     * {@link ViewPager#addOnPageChangeListener(ViewPager.OnPageChangeListener)
     * addOnPageChangeListener(OnPageChangeListener)} without removing the listener and
     * not cause a leak.
     */
    private static class BottomViewOnPageChangeListener implements ViewPager.OnPageChangeListener {
        private final WeakReference<NavigationBar> mBnveRef;

        public BottomViewOnPageChangeListener(NavigationBar bnve) {
        ...
        public void onPageSelected(final int position) {
            final NavigationBar bnve = mBnveRef.get();
...
//            Log.d("onPageSelected", "--------- position " + position + " ------------");
    ...
    private static class MyOnNavigationItemSelectedListener implements OnNavigationItemSelectedListener {
        ...
        MyOnNavigationItemSelectedListener(ViewPager viewPager, NavigationBar bnve, boolean smoothScroll, OnNavigationItemSelectedListener listener) {
...
//            Log.d("onNavigationItemSelecte", "position:"  + position);
    ...
    public NavigationBar enableShiftingMode(int position, boolean enable) {
        getBottomNavigationItemView(position).setShifting(enable);
        return this;
    }

    public NavigationBar setItemBackground(int position, int background) {
        getBottomNavigationItemView(position).setItemBackground(background);
        return this;
    }

    public NavigationBar setIconTintList(int position, ColorStateList tint) {
        getBottomNavigationItemView(position).setIconTintList(tint);
        return this;
    }

    public NavigationBar setTextTintList(int position, ColorStateList tint) {
     ...
     */
    public NavigationBar setIconsMarginTop(int marginTop) {
     ...
     * @param marginTop in px
     */
    public NavigationBar setIconMarginTop(int position, int marginTop) {
        /*
