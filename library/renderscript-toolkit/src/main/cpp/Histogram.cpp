...
namespace renderscript {
    ...
    HistogramDotTask::HistogramDotTask(const uchar *in, size_t sizeX, size_t sizeY,
                                       size_t vectorSize,
                                       uint32_t threadCount, const float *coefficients,
                                       const Restriction *restriction)
            : Task{sizeX, sizeY, vectorSize, true, restriction}, mIn{in},
              mSums(256 * threadCount, 0) {
        mThreadCount = threadCount;
...
////////////////////////////////////////////////////////////////////////////
    ...
    void RenderScriptToolkit::histogram(const uint8_t *in, int32_t *out, size_t sizeX, size_t sizeY,
        ...
        HistogramTask task(in, sizeX, sizeY, vectorSize, processor->getNumberOfThreads(),
                           restriction);
    ...
    void
    RenderScriptToolkit::histogramDot(const uint8_t *in, int32_t *out, size_t sizeX, size_t sizeY,
