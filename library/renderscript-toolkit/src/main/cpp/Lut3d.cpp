 ...
 */
    ...
    extern "C" void rsdIntrinsic3DLUT_K(void *dst, void const *in, size_t count, void const *lut,
                                        int32_t pitchy, int32_t pitchz, int dimx, int dimy,
                                        int dimz);
    ...
    void
    RenderScriptToolkit::lut3d(const uint8_t *input, uint8_t *output, size_t sizeX, size_t sizeY,
        ...
        Lut3dTask task(input, output, sizeX, sizeY, cube, cubeSizeX, cubeSizeY, cubeSizeZ,
                       restriction);
