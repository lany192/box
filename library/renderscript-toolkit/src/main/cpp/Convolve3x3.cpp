...
namespace renderscript {
    ...
    extern "C" void
    rsdIntrinsicConvolve3x3_K(void *dst, const void *y0, const void *y1, const void *y2,
 ...
 */
    ...
    void
    Convolve3x3Task::processData(int /* threadIndex */, size_t startX, size_t startY, size_t endX,
                                 size_t endY) {
    ...
    void
    RenderScriptToolkit::convolve3x3(const void *in, void *out, size_t vectorSize, size_t sizeX,
