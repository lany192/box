...
#   error "Require at least SSSE3"
    ...
    extern "C" void rsdIntrinsicConvolve3x3_K(void *dst, const void *y0,
        ...
        for (i = 0; i < count; ++i) {
            ...
            o0 = _mm_add_epi32(o0,
                               _mm_madd_epi16(_mm_unpacklo_epi16(p10, _mm_setzero_si128()), c8));
            o1 = _mm_add_epi32(o1,
                               _mm_madd_epi16(_mm_unpacklo_epi16(p11, _mm_setzero_si128()), c8));
    ...
    extern "C" void rsdIntrinsicConvolve5x5_K(void *dst, const void *y0,
        ...
        for (i = 0; i < count; ++i) {
            ...
            o0 = _mm_add_epi32(o0,
                               _mm_madd_epi16(_mm_unpacklo_epi16(p36, _mm_setzero_si128()), c24));
            o0 = _mm_srai_epi32(o0, 8);
            ...
            o1 = _mm_add_epi32(o1,
                               _mm_madd_epi16(_mm_unpacklo_epi16(p37, _mm_setzero_si128()), c24));
            o1 = _mm_srai_epi32(o1, 8);
            ...
            o2 = _mm_add_epi32(o2,
                               _mm_madd_epi16(_mm_unpacklo_epi16(p38, _mm_setzero_si128()), c24));
            ...
            o3 = _mm_add_epi32(o3,
                               _mm_madd_epi16(_mm_unpacklo_epi16(p39, _mm_setzero_si128()), c24));
