 ...
 */
    ...
    public:
        BlendTask(RenderScriptToolkit::BlendingMode mode, const uint8_t *in, uint8_t *out,
                  size_t sizeX,
...
// Convert vector to uchar4, clipping each value to 255.
    ...
    void
    RenderScriptToolkit::blend(BlendingMode mode, const uint8_t *in, uint8_t *out, size_t sizeX,
                               size_t sizeY, const Restriction *restriction) {
