...
public class SegmentTabLayout extends FrameLayout implements ValueAnimator.AnimatorUpdateListener {
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        mTextsize = ta.getDimension(R.styleable.SegmentTabLayout_tl_text_size, sp2px(13f));
        mTextSelectColor = ta.getColor(R.styleable.SegmentTabLayout_tl_text_select_color, Color.parseColor("#ffffff"));
        mTextUnselectColor = ta.getColor(R.styleable.SegmentTabLayout_tl_text_unselect_color, mIndicatorColor);
        mTextBold = ta.getInt(R.styleable.SegmentTabLayout_tl_text_bold, TEXT_BOLD_NONE);
        mTextAllCaps = ta.getBoolean(R.styleable.SegmentTabLayout_tl_text_all_caps, false);
