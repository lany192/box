...
import com.github.lany192.cropper.ImageAnimation;
...
import com.github.lany192.cropper.entity.RotateBitmapResult;
...
import com.github.lany192.cropper.listeners.OnSetCropOverlayMovedListener;
import com.github.lany192.cropper.listeners.OnSetCropOverlayReleasedListener;
import com.github.lany192.cropper.listeners.OnSetCropWindowChangeListener;
import com.github.lany192.cropper.listeners.OnSetImageUriCompleteListener;
import com.github.lany192.cropper.task.CropTask;
import com.github.lany192.cropper.task.LoadingTask;
...
public class CropImageView extends FrameLayout {
    ...
    public CropImageView(Context context, AttributeSet attrs) {
        ...
        mOverlayView = v.findViewById(R.id.OverlayView);
        mOverlayView.setCropWindowChangeListener(
                new OverlayView.CropWindowChangeListener() {
                    @Override
        ...
        mOverlayView.setInitialAttributeValues(options);
    ...
    public CropShape getCropShape() {
        return mOverlayView.getCropShape();
    }
    ...
    public void setCropShape(CropShape cropShape) {
        mOverlayView.setCropShape(cropShape);
    }
    ...
    public void setMultiTouchEnabled(boolean multiTouchEnabled) {
        if (mOverlayView.setMultiTouchEnabled(multiTouchEnabled)) {
            handleCropWindowChanged(false, false);
            mOverlayView.invalidate();
        }
    }
    ...
    public void setMinCropResultSize(int minCropResultWidth, int minCropResultHeight) {
        mOverlayView.setMinCropResultSize(minCropResultWidth, minCropResultHeight);
    }
    ...
    public void setMaxCropResultSize(int maxCropResultWidth, int maxCropResultHeight) {
        mOverlayView.setMaxCropResultSize(maxCropResultWidth, maxCropResultHeight);
    }
    ...
    public boolean isFixAspectRatio() {
        return mOverlayView.isFixAspectRatio();
    }
    ...
    public void setFixedAspectRatio(boolean fixAspectRatio) {
        mOverlayView.setFixedAspectRatio(fixAspectRatio);
    }
    ...
    public Guidelines getGuidelines() {
        return mOverlayView.getGuidelines();
    }
    ...
    public void setGuidelines(Guidelines guidelines) {
        mOverlayView.setGuidelines(guidelines);
    }
    ...
    public Pair<Integer, Integer> getAspectRatio() {
        return new Pair<>(mOverlayView.getAspectRatioX(), mOverlayView.getAspectRatioY());
    }
    ...
    public void setAspectRatio(int aspectRatioX, int aspectRatioY) {
        mOverlayView.setAspectRatioX(aspectRatioX);
        mOverlayView.setAspectRatioY(aspectRatioY);
    ...
    public void clearAspectRatio() {
        mOverlayView.setAspectRatioX(1);
        mOverlayView.setAspectRatioY(1);
    ...
    public void setSnapRadius(float snapRadius) {
        if (snapRadius >= 0) {
            mOverlayView.setSnapRadius(snapRadius);
        }
    }
    ...
    public Rect getCropRect() {
        ...
        return BitmapUtils.getRectFromPoints(
                ...
                orgWidth,
                orgHeight,
                mOverlayView.isFixAspectRatio(),
                mOverlayView.getAspectRatioX(),
    ...
    public RectF getCropWindowRect() {
        ...
        return mOverlayView.getCropWindowRect();
    }
    ...
    public float[] getCropPoints() {
        ...
        RectF cropWindowRect = mOverlayView.getCropWindowRect();
    ...
    public void resetCropRect() {
        ...
        mOverlayView.resetCropWindowRect();
    }
    ...
    public void rotateImage(int degrees) {
        if (mBitmap != null) {
            ...
            BitmapUtils.RECT.set(mOverlayView.getCropWindowRect());
    ...
    public Parcelable onSaveInstanceState() {
        ...
        bundle.putParcelable("INITIAL_CROP_RECT", mOverlayView.getInitialCropWindowRect());
        ...
        bundle.putString("CROP_SHAPE", mOverlayView.getCropShape().name());
        ...
        if (state instanceof Bundle) {
            ...
            if (mLoadingTask == null
                ...
                if (initialCropRect != null
                    ...
                    mOverlayView.setInitialCropWindowRect(initialCropRect);
                }
                ...
                mOverlayView.setCropShape(CropShape.valueOf(bundle.getString("CROP_SHAPE")));
        ...
        if (mLayoutWidth > 0 && mLayoutHeight > 0) {
            ...
            if (mBitmap != null) {
                ...
                if (mRestoreCropWindowRect != null) {
                    ...
                    mOverlayView.setCropWindowRect(mRestoreCropWindowRect);
                    handleCropWindowChanged(false, false);
                    mOverlayView.fixCurrentCropWindowRect();
                    mRestoreCropWindowRect = null;
    ...
    private void handleCropWindowChanged(boolean inProgress, boolean animate) {
        ...
        if (mBitmap != null && width > 0 && height > 0) {
            ...
            RectF cropRect = mOverlayView.getCropWindowRect();
            if (inProgress) {
                if (cropRect.left < 0
                        || cropRect.top < 0
    ...
    private void applyImageMatrix(float width, float height, boolean center, boolean animate) {
        if (mBitmap != null && width > 0 && height > 0) {
            ...
            mOverlayView.setCropWindowRect(cropRect);
            mapImagePointsByImageMatrix();
            mOverlayView.invalidate();
    ...
    private void setCropOverlayVisibility() {
        if (mOverlayView != null) {
            mOverlayView.setVisibility(mShowCropOverlay && mBitmap != null ? VISIBLE : INVISIBLE);
        }
    }
    ...
    private void updateImageBounds(boolean clear) {
        if (mBitmap != null && !clear) {
            ...
            mOverlayView.setCropWindowLimits(
